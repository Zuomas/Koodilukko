...
Koodilukko on vuona 2021 ohjelmointi 1-kurssilla itse suunnittelemani ja toteuttamani projekti. Ohjelma vaatii nelinumeroisen koodin oikeinkirjoitettuna, jonka
...
jonka jälkeen *-näppäintä. Mikäli koodi meni oikein, tulee syötön ajaksi keltainen
valo. Kun haluttu tuleva nelinumeroinen koodi on syötetty, täytyy painaa
vielä *-näppäintä, jolloin haluttu uusi koodi tallentuu vanhan tilalle.
